 ...
 */
    ...
    MON(NAM("tiger"), S_FELINE,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION,
        8, CLR_ORANGE, TIGER),
    MON(NAM("sphinx"), S_FELINE,
        LVL(9, 15, 3, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_HUMANOID, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE | M1_FLY, M2_FEMALE | M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION,
        11, CLR_ORANGE, SPHINX),
    ...
    MON(NAM("deeper one"), S_HUMANOID,
        ...
        M2_HOSTILE | M2_STALK | M2_GREEDY | M2_JEWELS | M2_COLLECT |
            M2_LORD | M2_STRONG | M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION,
        18, CLR_GREEN, DEEPER_ONE),
    MON(NAM("deepest one"), S_HUMANOID,
        ...
        M2_HOSTILE | M2_STALK | M2_GREEDY | M2_JEWELS | M2_COLLECT |
            M2_PRINCE | M2_STRONG | M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION,
        33, CLR_GREEN, DEEPEST_ONE),
    ...
    MON(NAM("brownie"), S_LEPRECHAUN,
        LVL(6, 15, 8, 20, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_SHOE, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(60, 30, MS_MUMBLE, MZ_TINY), 0, 0, M1_HUMANOID | M1_HERBIVORE,
        M2_COLLECT, M3_INFRAVISIBLE,
        8, CLR_BROWN, BROWNIE),
    MON(NAM("pooka"), S_LEPRECHAUN,
        LVL(8, 12, 8, 20, -4), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_TUCH,AD_SEDU,0,0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_LAUGH, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_HERBIVORE,
        M2_HOSTILE, M3_INFRAVISIBLE,
        10, CLR_WHITE, POOKA),
    ...
    MON(NAM("leocrotta"), S_QUADRUPED,
        ...
        M3_INFRAVISIBLE,
        8, CLR_RED, LEOCROTTA),
    MON(NAM("cow"), S_QUADRUPED,
        LVL(7, 9, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 8), ATTK(AT_KICK, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 300, MS_MOO, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
        M2_FEMALE | M2_WANDER | M2_DOMESTIC | M2_PEACEFUL, M3_INFRAVISIBLE,
        8, CLR_WHITE, COW),
    MON(NAM("wumpus"), S_QUADRUPED,
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE,
        9, CLR_CYAN, WUMPUS),
    MON(NAM("bull"), S_QUADRUPED,
        LVL(10, 15, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 2, 8), ATTK(AT_KICK, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(3000, 500, MS_MOO, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
        M2_MALE | M2_WANDER | M2_DOMESTIC | M2_HOSTILE, M3_INFRAVISIBLE,
        12, CLR_BLACK, BULL),
    ...
    MON(NAM("labyrinth trapper"), S_TRAPPER,
        LVL(14, 3, 3, 0, 0), (G_GENO | G_HELL | 2),
        A(ATTK(AT_TUCH, AD_STCK, 0, 0), ATTK(AT_ENGL, AD_DGST, 2, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 350, MS_SILENT, MZ_HUGE), 0, 0,
        M1_HIDE | M1_ANIMAL | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_CARNIVORE | M1_WALLWALK | M1_THICK_HIDE,
        M2_HOSTILE | M2_STALK | M2_STRONG, 0,
        16, CLR_GREEN, LABYRINTH_TRAPPER),
    ...
    MON(NAM("gold bug"), S_XAN,
        LVL(7, 15, -6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_EGLD, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(300, 50, MS_SILENT, MZ_TINY), MR_POISON, 0,
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_METALLIVORE,
        M2_HOSTILE | M2_GREEDY, 0, 9, HI_GOLD, GOLD_BUG),
    MON(NAM("xan"), S_XAN,
    ...
    MON(NAM("will o' wisp"), S_LIGHT,
        ...
        M1_FLY | M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS
            | M1_NOHEAD | M1_MINDLESS | M1_UNSOLID | M1_NOTAKE,
        M2_PEACEFUL | M2_NEUTER | M2_NOPOLY, M3_INFRAVISIBLE,
        9, CLR_WHITE, WILL_O_WISP),

    /*
     * zruty
     */
    MON(NAM("bannik"), S_ZRUTY,
        LVL(5, 10, 5, 15, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_HUGS, AD_SCLD, 2, 8), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 300, MS_MUMBLE, MZ_HUMAN), MR_FIRE | MR_POISON, 0,
        M1_HUMANOID | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        7, CLR_BLUE, BANNIK),
    MON(NAM("leshy"), S_ZRUTY,
        LVL(7, 15, 7, 25, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_GAZE, AD_CONF, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LAUGH, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_HERBIVORE, 0, M3_INFRAVISIBLE,
        9, CLR_GREEN, LESHY),
    ...
    MON(NAM("parrot"), S_BAT,
        LVL(4, 20, 6, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(40, 20, MS_PARROT, MZ_SMALL), 0, 0,
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_HERBIVORE,
        M2_WANDER | M2_HOSTILE, M3_INFRAVISIBLE, 6, CLR_BRIGHT_GREEN, PARROT),
    ...
    MON(NAM("bandersnatch"), S_JABBERWOCK,
        LVL(20, 8, 0, 65, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_STUN, 2, 10), ATTK(AT_ENGL, AD_DGST, 1, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1800, MS_BURBLE, MZ_GIGANTIC),
        MR_FIRE | MR_COLD | MR_SLEEP | MR_ELEC | MR_POISON | MR_ACID
            |MR_STONE, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_NOTAKE | M1_NOHANDS | M1_NOLIMBS
            | M1_ANIMAL | M1_THICK_HIDE | M1_REGEN | M1_HERBIVORE,
        M2_NEUTER, M3_CLOSE | M3_INFRAVISIBLE,
        22, CLR_WHITE, BANDERSNATCH),
    MON(NAM("jubjub bird"), S_JABBERWOCK,
        ...
        A(ATTK(AT_GAZE, AD_DRIN, 0, 0), ATTK(AT_BITE, AD_PHYS, 1, 10),
          ...
          NO_ATTK, NO_ATTK),
        SIZ(1500, 800, MS_SQAWK, MZ_LARGE), 0, 0,
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
    ...
    MON(NAM("shuggoth"), S_PUDDING,
        ...
        M2_HOSTILE | M2_NEUTER | M2_STALK | M2_NASTY | M2_STRONG
            | M2_COLLECT | M2_MAGIC, M3_INFRAVISION,
        21, CLR_BLACK, SHUGGOTH),
    MON(NAM("giant shuggoth"), S_PUDDING,
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 5, 10), ATTK(AT_CLAW, AD_PHYS, 5, 10),
          ...
          ATTK(AT_NONE, AD_CORR, 0, 0), ATTK(AT_ENGL, AD_ACID, 5, 10)),
        SIZ(2500, 500, MS_SILENT, MZ_LARGE),
        MR_COLD | MR_ELEC | MR_POISON | MR_ACID | MR_STONE,
        MR_COLD | MR_ELEC | MR_POISON,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
        ...
        M2_HOSTILE | M2_NEUTER | M2_STALK | M2_NASTY | M2_STRONG
            | M2_COLLECT | M2_MAGIC, M3_INFRAVISION,
        39, CLR_BLACK, GIANT_SHUGGOTH),
    /*
     * Quantum mechanics
     */
    MON(NAM("clockwork automaton"), S_QUANTMECH,
        ...
        M1_HUMANOID | M1_BREATHLESS, M2_STALK | M2_COLLECT,
        M3_CLOSE, 9, CLR_BROWN, CLOCKWORK_AUTOMATON),
    ...
    MON(NAM("quark"), S_QUANTMECH,
        LVL(9, 18, 0, 50, 0), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_FLVR, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON(NAM("disintegrator"), S_RUSTMONST,
        LVL(18, 8, 0, 20, -3), (G_HELL | G_GENO | G_NOCORPSE),
        A(ATTK(AT_CLAW, AD_DISN, 4, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 0, MS_HISS, MZ_LARGE), MR_DISINT | MR_STONE, 0,
        M1_ANIMAL | M1_TUNNEL | M1_NOTAKE | M1_NOHANDS | M1_REGEN,
        M2_NOPOLY | M2_HOSTILE | M2_WANDER | M2_NASTY, M3_INFRAVISIBLE,
        20, CLR_BRIGHT_GREEN, DISINTEGRATOR),
    ...
    MON(NAM("ouroboros"), S_SNAKE,
        ...
        A(ATTK(AT_TUCH, AD_PHYS, 1, 2), ATTK(AT_TUCH, AD_PHYS, 0, 0),
          ATTK(AT_HUGS, AD_WRAP, 1, 4), ATTK(AT_HUGS, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK),
        SIZ(250, 100, MS_HISS, MZ_LARGE), 0, 0,
    ...
    MON(NAM("fire vampire"), S_VAMPIRE,
        ...
        A(ATTK(AT_CLAW, AD_FIRE, 2, 4), ATTK(AT_CLAW, AD_FIRE, 2, 4),
          ATTK(AT_BITE, AD_DRLI, 2, 4), ATTK(AT_BITE, AD_DREN, 2, 4),
    ...
    MON(NAMS("vampire count", "vampire countess", "vampire noble"), S_VAMPIRE,
        LVL(16, 18, -2, 50, -9), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_BITE, AD_DRLI, 1, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP | MR_POISON, 0,
        M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_PRINCE
            | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE,
        18, HI_LORD, VAMPIRE_NOBLE),
    MON(NAM("star vampire"), S_VAMPIRE,
        ...
        A(ATTK(AT_TENT, AD_PHYS, 2, 6), ATTK(AT_TENT, AD_DRLI, 2, 6),
          ...
          ATTK(AT_TENT, AD_PHYS, 2, 6), ATTK(AT_TENT, AD_DRLI, 2, 6)),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_LARGE),
        MR_SLEEP | MR_POISON | MR_COLD, 0,
        M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_NEUTER,
        M3_INFRAVISIBLE, 21, CLR_WHITE, STAR_VAMPIRE),
    MON(NAM("nosferatu"), S_VAMPIRE,
        ...
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP | MR_POISON, 0,
        M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_MAGIC,
        M3_INFRAVISIBLE, 22, CLR_GRAY, NOSFERATU),
    ...
    MON(NAMS("ghoul king", "ghoul queen", "ghoul monarch"), S_ZOMBIE,
        LVL(10, 12, 4, 10, -4), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PLYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_MAGC, AD_SPEL, 7, 8), ATTK(AT_MAGC, AD_SPEL, 7, 8),
          NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_OMNIVORE,
        M2_UNDEAD | M2_WANDER | M2_HOSTILE | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISION,
        13, CLR_BLACK, GHOUL_MONARCH),
    MON(NAM("gug"), S_ZOMBIE,
        ...
        M1_HUMANOID | M1_POIS | M1_TUNNEL | M1_NEEDPICK | M1_THICK_HIDE
            | M1_CARNIVORE,
        M2_UNDEAD | M2_WANDER | M2_HOSTILE | M2_STRONG | M2_STALK
            | M2_COLLECT|M2_MAGIC,
        M3_INFRAVISION,
        18, CLR_BLACK, GUG),
    /*
    ...
    MON(NAM("silver golem"), S_GOLEM,
        LVL(18, 8, 1, 50, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 0, MS_SILENT, MZ_LARGE),
        MR_ACID | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0,
        22, DRAGON_SILVER, SILVER_GOLEM),
    ...
    MON(NAM("ruby golem"), S_GOLEM,
        LVL(24, 6, 3, 60, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_COLLECT, 0,
        28, CLR_RED, RUBY_GOLEM),
    MON(NAM("diamond golem"), S_GOLEM,
        LVL(26, 6, 3, 60, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_BREA, AD_MAGM, 5, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 0, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_COLLECT, 0,
        30, CLR_WHITE, DIAMOND_GOLEM),
    MON(NAM("sapphire golem"), S_GOLEM,
        LVL(28, 6, 3, 60, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_BREA, AD_ELEC, 5, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 0, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_COLLECT, 0,
        32, CLR_BLUE, SAPPHIRE_GOLEM),
    MON(NAM("steel golem"), S_GOLEM,
        LVL(30, 6, 3, 60, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 5, 10), ATTK(AT_BREA, AD_COLD, 5, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 0, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_COLLECT, 0,
        34, CLR_BRIGHT_BLUE, STEEL_GOLEM),
    MON(NAM("crystal golem"), S_GOLEM,
        LVL(32, 6, 3, 60, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 5, 12), ATTK(AT_BREA, AD_RBRE, 6, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 0, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
        M2_HOSTILE | M2_STRONG | M2_COLLECT, 0,
        36, DRAGON_SILVER, CRYSTAL_GOLEM),
    /*
    ...
    MON(NAM("poltergeist"), S_GHOST,
        ...
        SIZ(WT_HUMAN, 0, MS_SILENT, MZ_MEDIUM),
        MR_COLD | MR_DISINT | MR_SLEEP | MR_POISON | MR_STONE, 0,
        M1_FLY | M1_BREATHLESS | M1_UNSOLID | M1_SEE_INVIS | M1_NOHEAD
            | M1_AMORPHOUS| M1_NOEYES,
        M2_NOPOLY | M2_UNDEAD | M2_WANDER | M2_COLLECT | M2_MAGIC
            | M2_STALK | M2_HOSTILE | M2_NEUTER | M2_STRONG,
        M3_INFRAVISION, 16, CLR_YELLOW, POLTERGEIST),
...
#define SEDUCTION_ATTACKS_NO \
    ...
    MON(NAM("alchemist"), S_HUMAN, /* Some code assumes archeologist is first */
        LVL(10, 12, 10, 1, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
    ...
    MON(NAM("Unbioctium"), S_ELEMENTAL,
        LVL(16, 12, -2, 75, 18), (G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_BITE, AD_PHYS, 2, 8), ATTK(AT_BITE, AD_COLD, 2, 8),
          ATTK(AT_BITE, AD_ACID, 2, 8), ATTK(AT_CLAW, AD_ELEC, 2, 8),
          ATTK(AT_CLAW, AD_SAMU, 2, 6), ATTK(AT_NONE, AD_ELEC, 0, 4)),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_GIGANTIC),
        MR_COLD | MR_SLEEP | MR_DISINT | MR_ELEC | MR_POISON
            | MR_ACID | MR_STONE, 0, M1_SEE_INVIS | M1_POIS,
        M2_NOPOLY | M2_PNAME | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            | M2_COLLECT,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISION,
        23, CLR_CYAN, UNBIOCTIUM),
