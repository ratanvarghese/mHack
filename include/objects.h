...
GENERIC("heavy ball",  BALL_CLASS,    GENERIC_BALL),    /* [15] */
...
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      42,  2, 2, 1, RAY, HI_LEATHER, SPE_MAGIC_MISSILE),
...
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  42,  1, 1, 1, NODIR, HI_CLOTH, SPE_LIGHT),
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  40,  1, 1, 1, NODIR, HI_LEATHER,
                                                        SPE_DETECT_MONSTERS),
SPELL("healing",         "white",
...
SPELL("confuse monster", "orange",
      P_ENCHANTMENT_SPELL, 43,  2, 1, 1, IMMEDIATE, CLR_ORANGE,
                                                        SPE_CONFUSE_MONSTER),
...
SPELL("create monster",  "turquoise",
      P_CLERIC_SPELL,      32,  3, 2, 1, NODIR, CLR_BRIGHT_CYAN,
                                                        SPE_CREATE_MONSTER),
...
SPELL("launch boulder", "mauve",
      P_MATTER_SPELL,      10,  5, 5, 1, IMMEDIATE, CLR_MAGENTA,
                                                        SPE_LAUNCH_BOULDER),
