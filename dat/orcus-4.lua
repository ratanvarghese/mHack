...
des.door("random", 59,02)
des.door("random", 59,18)
des.door("random", 61,02)
des.door("random", 63,18)
des.door("random", 64,02)
des.door("random", 65,18)
des.door("random", 66,02)
des.door("random", 68,02)
des.door("random", 68,18)
des.door("random", 71,18)
des.door("random", 73,02)
des.door("random", 73,18)


des.altar({ x=38,y=18,align="noalign",type="sanctum" })
des.region({ region={32,02,33,03},lit=0,type="morgue",irregular=1,filled=1 })
des.region({ region={59,03,71,05},lit=0,type="morgue",irregular=1,filled=1 })
...
des.object({ id = "corpse", montype="gold dragon", coord=corpselocs:rndcoord(1) })
...
des.monster("vampire leader",37,04)
des.monster("vampire leader",39,04)
des.monster("vampire noble",37,03)
des.monster("vampire noble",39,03)
