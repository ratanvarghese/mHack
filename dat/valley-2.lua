...
-- The Morgues
des.region({ region={52,01,57,08},lit=0,type="morgue",filled=1 })
des.region({ region={59,14,66,18},lit=0,type="morgue",filled=1 })
des.region({ region={32,09,42,14},lit=0,type="morgue",filled=1 })
-- Stairs
