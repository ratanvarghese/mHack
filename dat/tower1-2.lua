...
des.monster({ id="vampire countess", x=04, y=04, name=Vnames[1], waiting=1 })
des.monster({ id="vampire countess", x=04, y=05, name=Vnames[2], waiting=1 })
des.monster({ id="vampire countess", x=04, y=06, name=Vnames[3], waiting=1 })
-- treasures
